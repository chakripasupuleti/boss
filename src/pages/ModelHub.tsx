...
import { ChevronRight, Play, RotateCcw, BarChart3, Clock, Target, HelpCircle, AlertCircle } from "lucide-react";
...
const modelContent = {
  numbers: {
    ...
    m4: {
      ...
      instruction: "Find the smallest value of $x$ such that $2579x25963$ is divisible by $11$.",
      difficulty: "Medium",
  ...
  percentages: {
    ...
    m2: {
      ...
      difficulty: "Easy",
      concept:
        "Use formula: $ \\frac{3}{4} \\div \\frac{1}{2} \\times 100 = \\frac{3}{4} \\times \\frac{2}{1} \\times 100 $.",
    },
    m3: {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
        ...
        <Link to="/courses/quant" className="hover:text-primary">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <Badge
            variant={
              currentModel.difficulty === "Easy"
                ? "secondary"
                : currentModel.difficulty === "Medium"
                  ? "outline"
                  : "destructive"
            }
          >
              ...
              <div className="p-4 rounded-lg bg-accent/5 border border-accent/20">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    <strong>Dynamic Learning:</strong> After your first attempt, you can adjust question parameters to
                    practice unlimited variations with AI-generated explanations.
                  </div>
                </div>
              </div>
            </CardContent>
